...
data class LibraryUiState(
    ...
    val totalCount:     Int               = 0,    // 290곡 등
    val totalLoops:     Int               = 0,    // 1247
    val totalMinutes:   Int               = 0,    // 7920 → "132h"
    val activeCount:    Int               = 0,    // 5곡 연습 중
    ...
    val selectedChip:   String            = "모두",  // 칩 rail 활성 칩
)
